...
urlpatterns = [
    ...
    path("configuracoes/avisos/aluno/", views.aviso_aluno_config_view, name="aviso_aluno_config"),
    path("configuracoes/avisos/aluno/preview/", views.aviso_aluno_preview_api, name="aviso_aluno_preview_api"),
    path("configuracoes/avisos/aluno/enviar-um/", views.aviso_aluno_enviar_um_api, name="aviso_aluno_enviar_um_api"),
    path("configuracoes/comunicado-geral/", views.comunicado_geral_view, name="comunicado_geral"),
    path("configuracoes/comunicado-geral/alunos/", views.comunicado_geral_alunos_api, name="comunicado_geral_alunos_api"),
    path("configuracoes/comunicado-geral/enviar-um/", views.comunicado_geral_enviar_um_api, name="comunicado_geral_enviar_um_api"),
    ...
    path("cadastros/alunos/<int:pk>/termo-imagem/registrar/", views.aluno_termo_registrar, name="aluno_termo_registrar"),
    path("cadastros/alunos/<int:pk>/termo-imagem/documento/", views.aluno_termo_documento, name="aluno_termo_documento"),
    path("cadastros/alunos/<int:pk>/termo-imagem/whatsapp/", views.aluno_termo_whatsapp, name="aluno_termo_whatsapp"),
    path("cadastros/alunos/<int:pk>/termo-imagem/assinar-local/", views.aluno_termo_assinar_local, name="aluno_termo_assinar_local"),
    path("cadastros/alunos/<int:pk>/termo-imagem/enviar-assinatura/", views.aluno_termo_enviar_assinatura_whatsapp, name="aluno_termo_enviar_assinatura_whatsapp"),
    path("termos/assinar/<str:token>/", views.termo_assinar, name="termo_assinar"),
    ...
    path("cadastros/alunos/<int:aluno_id>/aulas-avaliativas/criar/", views.aluno_aula_avaliativa_create, name="alunos_aula_avaliativa_create"),
    path("cadastros/alunos/<int:aluno_id>/aulas-avaliativas/<int:pk>/ficha/", views.aluno_aula_avaliativa_ficha, name="alunos_aula_avaliativa_ficha"),
    path("cadastros/alunos/<int:aluno_id>/aulas-avaliativas/<int:pk>/converter/", views.aluno_aula_avaliativa_converter, name="alunos_aula_avaliativa_converter"),
    ...
    path("agenda/semana/", views.aulas_semana, name="aulas_semana"),
    ...
    path("agenda/aulas/reservas/<int:reserva_id>/excluir/", views.aula_reserva_excluir, name="aulas_reserva_excluir"),
    ...
    path("reservas/<int:reserva_id>/editar-aula/", views.aluno_reserva_editar, name="reservas_editar_aula"),
